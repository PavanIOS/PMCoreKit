...
import UIKit
 ...
 public class Device {
    ...
    static var uuidString: String {
        return UIDevice.current.identifierForVendor?.uuidString ?? "" // .current.identifierForVendor!.uuidString
    }
    ...
    // To check connected with Xcode on running from Xcode
